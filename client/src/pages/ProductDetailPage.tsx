...
// import { getProductBySlug, getRelatedProducts } from '../lib/localStore';
...
//       setLoading(true);
//       const data = slug ? getProductBySlug(slug) : null;

//       if (data) {
//         setProduct(data);
//         setRelated(getRelatedProducts(data.category_id, data.id) as Product[]);
//       } else {
//         setProduct(null);
//         setRelated([]);
//       }
